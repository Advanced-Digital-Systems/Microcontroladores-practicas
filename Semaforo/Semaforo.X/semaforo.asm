...
INITIALIZE:
		BSF	TRISC,	0	; RC0 is input
		MOVLW	b'10000000'	; Timer0 of .524288 sec
		MOVWF	T0CON		; Configure Timer0.
		CLRF	TRISD		; Port D is an Output
		MOVLW	15		; 15 times half a second for GREEN
		MOVWF	GREENL		; Saves the value
		MOVLW	2		; 2 times half a second for YELLOW
		MOVWF	YELLOWL		; Saves the value
		MOVLW	9		; 9 times half a second for RED
		MOVWF	REDL		; Saves the value
		MOVLW	b'00010001'	; _ _ _ GREEN YELLOW RED WALK NWALK
		MOVWF	PORTD		; Saves the value in Port D
		MOVLW	3		; 3 button pushes
		MOVWF	BUT		; Saves the value
		GOTO	GREEN		; Initialice GREEN loop
